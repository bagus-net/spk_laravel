...
<div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
    <form action="{{ route('bobot.add') }}" method="POST">
    	@csrf
        ...
        <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-10">
              <input class="form-control" type="text" name="nilai_bobot" value="" id="example-text-input" placeholder="masukan nilai bobot">
              </div>
          </div>
