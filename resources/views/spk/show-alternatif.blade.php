...
@section('content')
    @component('common-components.breadcrumb')
        ...
        @slot('title') Show alternatif @endslot
    @endcomponent
...
<div class="row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-md-10">
            <input class="form-control" type="text" name="kode_alternatif" value="{{$find->kode_alternatif}}" id="example-text-input" placeholder="masukan kode alternatif">
            </div>
        </div>
